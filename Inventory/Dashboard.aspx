<%@ Page Title="" Language="C#" MasterPageFile="~/InventoryMas.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="Inventory.Dashboard" %>
                ...
                <div class="row">
                    <div class="col-xl-5 d-flex">
                        <div class="dash-user-card w-100">
                            ...
                            <div class="dash-btns">
                                <a href="#" class="btn view-company-btn">View Companies</a>
                                <a href="#" class="btn view-package-btn">All Packages</a>
                            </div>
                            <div class="dash-img">
                                <img src="../Content/assets/img/dashboard-card-img.png" alt="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row dash-company-row w-100 m-0">
                            <div class="col-lg-3 col-sm-6 d-flex">
                                <div class="company-detail-card w-100">
                                    <div class="company-icon">
                                        <img src="../Content/assets/img/icons/dash-card-icon-01.svg" alt="">
                                    </div>
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex">
                                <div class="company-detail-card bg-info-light w-100">
                                    <div class="company-icon">
                                        <img src="../Content/assets/img/icons/dash-card-icon-02.svg" alt="">
                                    </div>
                                    <div class="dash-comapny-info">
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex">
                                <div class="company-detail-card bg-pink-light w-100">
                                    <div class="company-icon">
                                        <img src="../Content/assets/img/icons/dash-card-icon-03.svg" alt="">
                                    </div>
                                    <div class="dash-comapny-info">
                            ...
                            <div class="col-lg-3 col-sm-6 d-flex">
                                <div class="company-detail-card bg-success-light w-100">
                                    <div class="company-icon">
                                        <img src="../Content/assets/img/icons/dash-card-icon-04.svg" alt="">
                                    </div>
                                    <div class="dash-comapny-info">
                        ...
                        <div class="card super-admin-dash-card">
                            <div class="card-header">
                                <div class="row align-center">
                                    ...
                                    <div class="col-auto">
                                        <a href="#" class="btn-right btn btn-sm btn-outline-primary">View All 
                                        </a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-01.svg" alt="Company Image"></a>
                                                        <a href="#">Hermann Groups <span class="plane-type">Basic (Monthly)</span></a>

                                                    </h2>
                                                </td>
                                                <td>24 Feb 2024</td>
                                                <td class="text-end"><a href="#" class="view-companies btn">View</a></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-02.svg" alt="Company Image"></a>
                                                        <a href="#">Skiles LLC <span class="plane-type">Enterprise (Yearly)</span></a>
                                            ...
                                            <tr>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-03.svg" alt="Company Image"></a>
                                                        <a href="#">Kerluke Group <span class="plane-type">Advanced (Monthly)</span></a>
                                            ...
                                            <tr>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-04.svg" alt="Company Image"></a>
                                                        <a href="#">Schowalter Group <span class="plane-type">Basic (Yearly)</span></a>
                                            ...
                                            <tr>
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-05.svg" alt="Company Image"></a>
                                                        <a href="#">Accentric Global <span class="plane-type">Basic (Monthly)</span></a>
                                ...
                                <div class="dash-plane-list">
                                    <div class="plane-info">
                                        <span class="icon-plane">
                                            <img src="../Content/assets/img/icons/dashboard-plane-icon.svg" alt=""></span>
                                ...
                                <div class="dash-plane-list">
                                    <div class="plane-info">
                                        <span class="icon-company">
                                            <img src="../Content/assets/img/companies/company-01.svg" alt=""></span>
                        ...
                        <div class="card super-admin-dash-card flex-fill">
                            ...
                            <div class="card-body p-0">
                                <div class="dash-plane-list">
                                    <div class="plane-info">
                                        <span class="icon-company">
                                            <img src="../Content/assets/img/companies/company-04.svg" alt=""></span>
                                        <div class="plane-name">
                        ...
                        <div class="card super-admin-dash-card">
                            <div class="card-header">
                                <div class="row align-center">
                                    ...
                                    <div class="col-auto">
                                        <a href="invoices.html" class="btn-right btn btn-sm btn-outline-primary">View All 
                                        </a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-01.svg" alt="Company Image">
                                                        </a>
                                                ...
                                                <td>Basic
                                                    <br>
                                                    <span class="plane-type">(Monthly)</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-02.svg" alt="Company Image">
                                                        </a>
                                                        <a href="#">Skiles LLC</a>
                                                    </h2>
                                                </td>
                                                <td>Enterprise
                                                    <br>
                                                    <span class="plane-type">(Yearly)</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-03.svg" alt="Company Image">
                                                        </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-04.svg" alt="Company Image">
                                                        </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="#" class="company-avatar avatar-md me-2 companies company-icon">
                                                            <img class="avatar-img rounded-circle company" src="../Content/assets/img/companies/company-05.svg" alt="Company Image">
                                                        </a>
                        ...
                        <div class="card super-admin-dash-card">
                            <div class="card-header">
                                <div class="row align-center">
                                    ...
                                    <div class="col-auto">
                                        <a href="packages.html" class="btn-right btn btn-sm btn-outline-primary">View All 
                                        </a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-stripped table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="expired-date">Expired On
                                                    <br>
                                                    24 Feb 2024</td>
                                            </tr>
                                            <tr>
